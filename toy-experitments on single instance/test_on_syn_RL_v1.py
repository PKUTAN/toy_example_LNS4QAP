...
if __name__ == '__main__':
    ...
    parser.add_argument('--rate', default=0.005, type=float, help='learning rate')
    ...
    parser.add_argument('--rmsize', default=400, type=int, help='memory size')
    ...
    for epoch in range(num_epochs):
        ...
        for instances in train_dataloader:
            ...
            for cycle in range(100):
                ...
                count_0 = 0
                total_reward  = 0
                for t_rollout in tqdm(range(50)):
