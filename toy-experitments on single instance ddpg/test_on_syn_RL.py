...
if __name__ == '__main__':
    ...
    parser.add_argument('--rmsize', default=500, type=int, help='memory size')
        ...
        for instances in train_dataloader:
            ...
            for i in range(100):
                ...
                for t_rollout in range(50):
                    ...
                    # print('cur_objs:{},reward:{}'.format(cur_objs,reward))           
                    if t_rollout > args.warmup:
                        agent.update_policy()
                        # print('policy_loss:{},critic_loss:{}'.format(agent.actor_loss,agent.critic_loss))
                print(actions_prob)
                print(actions_prob.sum())
                print('epoch:{},episode:{},t_rollout:{},name:{},reward:{},object:{}'.format(epoch,step,t_rollout,names,total_reward,next_objs))
                step += 1
