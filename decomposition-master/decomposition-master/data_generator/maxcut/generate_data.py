...
def main(outFolder, offset, max_n, min_n, g_type, edge, N=200):
  ...
  if 'unlabeled' in outFolder:
      solve = False
  #elif ('test' in outFolder) or ('valid' in outFolder):
  #    N = 100
...
def cmdLineParser():
  ...
  parser.add_argument('-o', dest='outFolder', type=str, action='store', \
                      default='../../../data/maxcut_test/', help='Output Folder')
...
if __name__ == '__main__':
  ...
  for kk, cstep in enumerate(range(args.numSteps)):
    ...
    for prefix in folders:
      ...
      main(folderPrefix, offset, max_n, min_n, args.g_type, args.edge, args.num)
